  ...
  node_pools = [
    {
      ...
      node_locations            = "europe-central2-a,ueurope-central2-b"
      min_count                 = 1
      max_count                 = 2
      local_ssd_count           = 0
      spot                      = false
      ...
      auto_repair               = true
      auto_upgrade              = true
      service_account           = "doker-pull-push@celtic-beacon-387519.iam.gserviceaccount.com"
      preemptible               = false
